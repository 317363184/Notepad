...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mText.setBackgroundColor(NoteAttribute.snoteBackground);
     ...
     */
    @Override
    protected void onSaveInstanceState(Bundle outState) {//用于活动被回收后onCreate()方法中的参数
     ...
     */
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {//整个activity开始就调用一次
    ...
    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {//要改变menu需要这个方法
